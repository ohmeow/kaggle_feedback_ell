...
from transformers.file_utils import WEIGHTS_NAME, TF2_WEIGHTS_NAME, TF_WEIGHTS_NAME
...
def get_checkpoint_from_transformer_cache(
    ...
    try:
        ...
        #     archive_file, cache_dir=cache_dir, force_download=force_download, proxies=proxies, resume_download=resume_download
        # )
